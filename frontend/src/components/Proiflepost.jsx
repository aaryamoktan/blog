const Proiflepost = () => {
  return (
    <div><div className='w-full flex flex-col md:flex-row justify-center items-center mt-10 space-x-10 mb-10 '>
    <div className='w-[90%] h-[200px] flex justity-center items-center '>
